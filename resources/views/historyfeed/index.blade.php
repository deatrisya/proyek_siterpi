                        ...
                        <div class="row align-items-end mb-5">
                            <div class="col-md-3">
                                <div class="">
                                    ...
                                    <select class="form-select" id="feed_name" name="feed_name">
                                        <option value="">-- Pilih Nama Pakan --</option>
                                        @foreach ($feed as $data)
                                            <option value="{{ $data->id }}">{{ $data->nama_pakan }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
...
@section('js')
    ...
    <script>
        ...
        function printData(url) {
            ...
            var feeds = document.getElementById('feed_name').value;

            window.open(url + '?from_date=' + from_date + '&to_date=' + to_date + '&feed_id=' + feeds);
        }
    </script>
@endsection
